...
* signal-spotter-cloud:StockTradingStateMachine
* signal-spotter-cloud:StockCheckerFunction (java8)
* signal-spotter-cloud:StockSellerFunction (java8)
* signal-spotter-cloud:StockBuyerFunction (java8)
* signal-spotter-cloud:TransactionTable
